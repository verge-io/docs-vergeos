...
3. Click the **Copy** button next to the main disk on the VM.
   ![nonpersistent-2.png](../assets/screenshots/non-persistent-copy.png)
4. Change the **Media Type** to **Non-Persistent** and click **Submit** at the bottom.
5. Click the **Edit** icon ![edit icon pencil](../assets/screenshots/edit-icon-pencil.png) for the original **Disk Media Type**.
{% hint style="info" %}
