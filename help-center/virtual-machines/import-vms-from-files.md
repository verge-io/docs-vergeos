...
1. Upload the configuration and disk image files to the vSAN. For instructions, see [Managing Files](managing-files.md).
...
8. Select the **Preferred Tier**, or leave it at the default. This specifies the storage tier for the VM's disks. See [Preferred Tier Usage](../storage-vsan/preferred-tier-usage.md) for more details.
...
1. Upload the disk image files to the vSAN. See [Managing Files](managing-files.md) for details.
