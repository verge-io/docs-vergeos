...
![Create tag category - Light Mode](../assets/screenshots/new-tag-category-vms-light.png)
![Create tag category - Dark Mode](../assets/screenshots/new-tag-category-vms-dark.png) 

**Double-click category created above >**  ***New***   

![New tag - Light Mode](../assets/screenshots/create-vm-tag-light.png)

![New tag - Dark Mode](../assets/screenshots/create-vm-tag-dark.png)
{% endhint %}
...
![Assign tag to VMs - Light Mode](../assets/screenshots/assign-tag-vms-light.png)

![Assign tag to VMs - Dark Mode](../assets/screenshots/assign-tag-vms-dark.png) 


The VMs will now show the assigned tag in the ***Tags*** column.

![VMs with tag - Light Mode](../assets/screenshots/vms-tags-column-light.png)

![VMs with tag - Dark Mode](../assets/screenshots/vms-tags-column-dark.png)
{% endhint %}
...
![Task to power on tagged VMs - Light Mode](../assets/screenshots/task-poweron-jthompson-light.png)

![Task to power on tagged VMs  - Dark Mode](../assets/screenshots/task-poweron-jthompson-dark.png)   
{% endhint %}
...
![Event trigger user login - Light Mode](../assets/screenshots/jthompson-event-login-light.png)

![Event trigger user login - Dark Mode](../assets/screenshots/jthompson-event-login-dark.png) 
{% endhint %}
...
![Task to power off tagged VMs - Light Mode](../assets/screenshots/task-poweroff-jthompson-light.png)

![Task to power off tagged VMs - Dark Mode](../assets/screenshots/task-poweroff-jthompson-dark.png) 
{% endhint %}
...
![Event trigger user logout - Light Mode](../assets/screenshots/jthompson-event-logoff-light.png)

![Event trigger user logout - Dark Mode](../assets/screenshots/jthompson-event-logoff-dark.png) 
{% endhint %}
...
![Schedule COB - Light Mode](../assets/screenshots/schedule-eob-friday-light.png)

![Schedule COB - Dark Mode](../assets/screenshots/schedule-eob-friday-dark.png) 
{% endhint %}
...
![Schedule trigger - Light Mode](../assets/screenshots/jthompson-schedule-poweroff-light.png)

![Schedule trigger - Dark Mode](../assets/screenshots/jthompson-schedule-poweroff-dark.png) 
{% endhint %}
