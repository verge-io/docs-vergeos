...
**Common Next Steps**:
- Power on VM → [`VM Power Management`](vm-power-management.md)
- Configure settings → [`VM Configuration`](vm-configuration.md)
...
### Next Steps
After VM creation → Power Management ([`VM Power Management`](vm-power-management.md))
...
- **Power Management**: See [`VM Power Management`](vm-power-management.md) for starting/stopping VMs
- **Configuration**: See [`VM Configuration`](vm-configuration.md) for CPU/RAM changes  
