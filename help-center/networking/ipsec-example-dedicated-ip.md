...
{% hint style="info" %}
**Consult the [IPsec Product Guide Page](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/vpn/ipsec) for step-by-step general instructions on creating an IPsec tunnel.**
...
The public address must be [Assigned from the External network](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/networks/assign-external-ip) to the VPN network.
...
{% hint style="info" %}
**The translate rule must be moved to the top of the rules list, before the *Accept* Rules.  Instructions for changing the order of rules can be found in the Product Guide: [Network Rules - Change the Order of Rules](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/networks/network-rules#change-the-order-of-rules)**
