...
For more advanced scenarios including virtual switch ports and detailed NAT configurations, see [How to Use External IPs in Tenants](../networking/how-to-use-external-ips-in-tenants.md).
{% endhint %}
