...
{% hint style="info" %}
**For more information on Snapshots and Site Syncs, refer to our [Product Guide on Sync Configuration](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/product-guide/backup-dr/sync-configuration).**
