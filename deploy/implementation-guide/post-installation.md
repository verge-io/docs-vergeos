...
categories:
  - Installation
description: >-
  Essential post-installation steps for VergeOS including system health
  verification, core network redundancy testing, external connectivity
  validation, and initial system configuration.
tags:
  - post-installation
  - verification
  - network-redundancy
...
* **Confirm System Health:**
  * Check the Main Dashboard (home page) for any warnings or alerts, including the _Logs_ section at the bottom of the page.
  * Ensure all nodes are showing as online and healthy. The _Nodes_ tile on the Main Dashboard should display all nodes online with a green status.
...
* **Test Core Network Redundancy**\
  ...
  * Within the VergeOS UI, navigate to _Nodes_. Wait several minutes to verify that all nodes appear with "Running"/green status.
...
* VergeOS provides configuration options for you to secure and maximize the benefits of your new system. Follow the [**New System Configuration Checklist**](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/platform-overview/new-system-configuration) in the Product Guide to finish preparing your environment for production.
