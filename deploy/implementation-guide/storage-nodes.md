...
* The 2 node cluster from the [Installation Guide](installation-guide.md) is installed and fully operational.
...
{% hint style="warning" %}
**If this will be the first node in a new storage cluster**
