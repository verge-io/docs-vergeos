...
{% hint style="info" %}
**Information about encrypting a Site Synchronization can be found in the [Product Guide](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/product-guide/backup-dr/sync-configuration)**
