...
description: >-
  Learn how to identify and locate a failed disk drive in your VergeOS
  environment using the LED control diagnostic tool for physical drive location.
tags:
  - disk
  - failed
  - troubleshooting
...
{% hint style="info" %}
**For detailed instructions on drive replacement, refer to the Maintenance section in the inline help under** [**Drive Replacement**](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/system-administration/drive-replacement)**. This section guides you through the entire process.**
{% endhint %}
