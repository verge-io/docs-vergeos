...
description: >-
  Guide to setting up Storware for virtual machine protection on VergeOS,
  including NAS service configuration and NFS setup.
tags:
  - backup
  - storware
  - virtual machines
...
1. **Deploy the NAS Service:**
   * Access the VergeOS UI and deploy a new NAS service. [Add a NAS Service](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/nas/nas-service).
