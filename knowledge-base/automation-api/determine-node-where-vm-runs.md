...
description: >-
  Explains VM options that control which node a VM runs on, including HA group
  affinity and anti-affinity, preferred node, preferred cluster, and failover
  cluster settings.
tags:
  - virtual machine
  - vms
...
{% hint style="info" %}
**For more information about these and other VM options, see:** [**Product Guide - Virtual Machine Fields**](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/virtual-machines/vm-field-descriptions)
{% endhint %}
