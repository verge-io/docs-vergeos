...
![Create webhook - Light Mode](../assets/screenshots/webhook-slack-light.png)
![Create webhook - Dark Mode](../assets/screenshots/webhook-slack-dark.png) 
{% endhint %}
...
![Create webhook - Light Mode](../assets/screenshots/task-email-light.png)
![Create webhook - Dark Mode](../assets/screenshots/task-email-dark.png) 
{% endhint %}
...
![Create Slack webhook task - Light Mode](../assets/screenshots/task-webhook-light.png)
![Create Slack webhook task - Dark Mode](../assets/screenshots/task-webhook-dark.png) 
{% endhint %}
...
![Assign Event Trigger to Slack Task- Light Mode](../assets/screenshots/slack-send-event-trigger-light.png)
![Assign Event Trigger to Slack Task- Dark Mode](../assets/screenshots/slack-send-event-trigger-dark.png) 
{% endhint %}
...
![Assign Event Trigger to Email Task - Light Mode](../assets/screenshots/send-email-event-trigger-light.png)
![Assign Event Trigger to Email Task - Dark Mode](../assets/screenshots/send-email-event-trigger-dark.png) 
{% endhint %}
...
If you want the same trigger to apply to multiple, or even all, outgoing sync jobs, assign a shared [Tag](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/system/tags) to those syncs. You can then configure the trigger to fire whenever any sync with that tag produces an error.
{% endhint %}
...
- [Configuring Webhooks](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/product-guide/automation/webhooks)
- [Working with Tags](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/system/tags)
- [SMTP Configuration](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/system/smtp)
