...
**Previous**: VM created → [`VM Creation`](vm-creation-api.md)
**Common Next Steps**:
- Configure VM settings → [`VM Configuration`](vm-configuration.md)
...
- **VM Creation**: See [`VM Creation`](vm-creation-api.md) for creating VMs
