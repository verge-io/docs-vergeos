...
{% hint style="success" %}
**Instructions for uploading files to the vSAN can be found [here](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/storage/uploading-files-to-vsan)**


{% endhint %}

2. **Create one or more Custom Themes**: to implement your branding  
Refer to the [Themes Product Guide](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/system/themes) for instructions. 
