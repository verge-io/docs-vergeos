...
description: >-
  Guide on how to customize branding, logos, colors, and themes in the VergeOS
  UI, including light and dark mode support and multi-tenant branding.
tags:
  - branding
  - color
  - dashboard
...
{% hint style="success" %}
**Instructions for uploading files to the vSAN can be found** [**here**](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/storage/uploading-files-to-vsan)
{% endhint %}

2. **Create one or more Custom Themes**: to implement your branding\
   Refer to the [Themes Product Guide](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/system-administration/themes) for instructions.
