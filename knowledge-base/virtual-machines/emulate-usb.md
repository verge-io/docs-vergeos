...
description: >-
  Instructions for creating and attaching an emulated USB device to a VM in
  VergeOS, including hotplug configuration and VirtIO driver requirements.
tags:
  - usb
  - device
  - drive
...
For additional drive configuration options, see: [VM Drives](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/virtual-machines/vm-drives)
