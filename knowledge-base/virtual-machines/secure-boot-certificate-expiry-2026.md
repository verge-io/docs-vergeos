...
If you encounter issues applying the Secure Boot certificate fix or have questions about affected VMs, please don't hesitate to reach out to the [VergeOS Support Team](https://app.gitbook.com/s/uJc5d3O7cwI7qD8muSyG/support-and-services).
{% endhint %}
