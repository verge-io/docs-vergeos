...
description: >-
  Step-by-step instructions for adding a Trusted Platform Module (TPM) device to
  a virtual machine in VergeOS, including UEFI configuration, guest OS setup,
  and BitLocker enablement.
tags:
  - tpm
  - virtual machine
  - device
...
* [Virtual Machine Best Practices](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/virtual-machines/vm-best-practices)
* [UEFI Import Guide](importing-windows-server-with-uefi-into-vergeos.md)
* [Device Passthrough Overview](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/system-administration/device-pass-overview)
