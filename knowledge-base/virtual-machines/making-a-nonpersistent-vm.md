...
description: >-
  How to create a non-persistent virtual machine in VergeOS that reverts to its
  original state after each reboot, ideal for VDI environments.
tags:
  - vm
  - persistent
  - non persistent
...
3. Click the **Copy** button next to the main disk on the VM. ![nonpersistent-2.png](../.gitbook/assets/non-persistent-copy.png)
