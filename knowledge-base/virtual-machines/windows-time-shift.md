...
description: >-
  How to resolve time drift in Windows VMs on VergeOS by configuring the RTC
  Base setting and the RealTimeIsUniversal registry key for proper UTC time
  handling.
tags:
  - windows
  - time
...
![alt text](../.gitbook/assets/rtcbase-utc-screenshot.png)
