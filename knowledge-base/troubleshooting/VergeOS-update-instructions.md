...
description: >-
  Step-by-step instructions for updating a VergeOS environment with zero
  downtime, including troubleshooting common update issues.
tags:
  - verge.io
  - update
  - upgrade
...
> For more information on the update process, please refer to our [Product Guide](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/system-administration/licensing-and-updates).
...
2. Navigate to **System > Updates**, then select **Check for Updates** in the left menu.
   ...
   * If a banner appears stating "A new minor version is available on a different branch," follow the prompt to change branches by selecting **Change Branch** in the left menu. Confirm with **Yes**. ![VergeOSupgrade-new-img2.png](../.gitbook/assets/vergeioupgrade-new-img2.png)
3. The packages to be downloaded will now be highlighted. ![VergeOSupgrade-new-img3.png](../.gitbook/assets/vergeioupgrade-new-img3.png)
