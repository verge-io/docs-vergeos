...
description: >-
  Complete guide to setting up authoritative DNS services in VergeOS using BIND,
  including DNS views, zones, records, and firewall configuration.
tags:
  - dns
  - bind
  - authoritative
...
2. **Configure DNS settings**:
   ...
   * Select **Bind** from the available options:
     * _**Bind**_ - Enables full authoritative DNS server capabilities
     * _**Simple**_ - Basic DNS forwarding (not authoritative)
     * _**Disabled**_ - No DNS services
     * _**Other Network**_ - Forward to another network's DNS
...
* [VergeOS Network Troubleshooting](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/networking/net-troubleshooting)
* [VergeOS Firewall Rules Configuration](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/networking/network-rules)
* [VergeOS Network Dashboards](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/networking/network-dashboards)
