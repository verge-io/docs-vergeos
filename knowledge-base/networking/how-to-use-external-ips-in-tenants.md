...
For instructions on creating a Virtual Switch Port, see [Creating a Virtual Switch Port](https://app.gitbook.com/o/FpusSnrkRHyZiVEsXf9X/s/QZBMFpokMv2vWTIRbFzA/knowledge-base/tenant/provide-layer2-to-tenant).
