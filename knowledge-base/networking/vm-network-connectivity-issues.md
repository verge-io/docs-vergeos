...
description: >-
  Troubleshooting guide for common VM network connectivity problems including
  missing NIC configuration, incorrect network assignment, improper IP settings,
  and missing Virtio drivers.
tags:
  - vm
  - networking
  - nic
...
* **Virtio Drivers Not Installed**: If the Virtio drivers are not installed, the NIC may not function properly. For instructions on installing Virtio drivers, refer to the [Product Guide](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/virtual-machines/vm-guest-agent).
