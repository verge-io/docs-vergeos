...
{% hint style="warning" %}
**Always Submit a Diagnostics Bundle**
...
{% hint style="info" %}
**Triage Guidance, Not Contracted SLAs**

The severity tiers and expected response times above are general triage guidance for prioritizing internal escalation, not contracted SLA terms. The published VergeOS Support Options commitment is a response to all inquiries within **24 business hours**, with phone support for urgent issues outside business hours.
{% endhint %}
...
- **Boot or BIOS issues** — Storage controllers must be in JBOD/HBA mode, not RAID. UEFI boot is required when all drives are NVMe; otherwise Legacy or Dual mode is supported. If the installer does not detect drives, escalate before attempting workarounds
...
This responsibility matrix is training guidance to set expectations between an internal admin team and VergeOS support. It is not a contractual RACI table published by VergeOS — confirm specific boundaries with your support contact.
{% endhint %}
