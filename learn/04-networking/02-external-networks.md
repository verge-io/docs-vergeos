...
Coming from VMware? VergeOS external networks combine VLAN tagging, static routes, NIC teaming, HA, and per-network rate limiting into a single configuration form — no separate vDS, NSX Edge, or external load balancer required.
{% endhint %}
...
With external networks connecting VergeOS to upstream infrastructure, the next topic covers how to build isolated virtual networks for your workloads: **[Internal Networks & DHCP/DNS →](03-internal-networks.md)**
