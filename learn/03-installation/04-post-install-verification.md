...
- **Tier 0** — Metadata only (vSAN hash map and filesystem index, NTP drift files, adjtime, and general system metadata). Stored on high-endurance NVMe drives. This is **not** a performance cache tier.
...
- Core1 and Core2 are on dedicated L2 networks (separate VLANs satisfy this)
...
If your cluster has two or more nodes:
...
- **Plan tenant creation** and resource allocation (see [Module 7: Multi-Tenancy](../07-multi-tenancy/README.md))
- **Deploy production VMs** and workloads (see [Module 6: Virtual Machines](../06-virtual-machines/README.md))
- **Schedule regular health checks** to maintain system health over time

Continue to the hands-on lab to practice a complete installation workflow: **[Lab: 2-Node Installation →](lab.md)**
