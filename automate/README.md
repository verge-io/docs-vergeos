...
1. [API keys](product-guide/system/api-keys.md)
2. [Backup & disaster recovery](product-guide/backup-dr/overview.md)
3. [Recipes](product-guide/automation/recipes-overview.md)
4. [VergeOS CLI](product-guide/tools-integrations/vrg-cli.md)
5. [Private AI overview](product-guide/private-ai/overview.md)
