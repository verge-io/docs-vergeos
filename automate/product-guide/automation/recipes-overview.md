...
1. **[Explore the Recipe Marketplace](vm-recipes.md#included-vm-recipes)** - Browse ready-to-use VM recipes
2. **[Create your first VM recipe](vm-recipes.md)** - Build a custom template from an existing VM
3. **[Organize with catalogs](recipes-organization.md)** - Set up repositories for recipe management

## Key Features

* **Out-of-the-box Samples:** The [**Recipe Marketplace**](vm-recipes.md#included-vm-recipes) is automatically available with ready-to-use recipes that can also be cloned and fine-tuned to fit your specific requirements.
* **Recipe Exchange:** [**Share Recipes**](recipes-organization.md#sharing-recipes) with tenants and between VergeOS systems. 
...
### Getting Started
- [Recipe Organization (Repositories/Catalogs)](recipes-organization.md)
- [VM Recipes](vm-recipes.md)
- [Tenant Recipes](tenant-recipes.md)

### Advanced Topics
- [Cloud-Init Integration](vm-recipes.md#advanced-usage)
- [Recipe Sharing Between Systems](recipes-organization.md#sharing-recipes)
- [Recipe Marketplace](vm-recipes.md#included-vm-recipes)