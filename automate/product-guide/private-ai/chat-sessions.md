...
{% hint style="success" %}
**A chat session requires a configured model and assistant; see the [AI Configuration Guide](configuration.md) for setup instructions.**
...
{% hint style="info" %}
**Attached file contents are merged into the prompt and affect total context size.**
...
Assistant settings allow controlling chat history default settings across sessions. See [AI Assistant Management](configuration.md#ai-assistant-management).  
