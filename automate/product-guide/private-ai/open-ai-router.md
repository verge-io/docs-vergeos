...
For detailed instructions on creating and configuring assistants, see the [AI Configuration Guide](configuration.md#ai-assistant-management).

{% hint style="success" %}
**Key Settings for API Usage**
