...
- Removing immutability triggers a mandatory unlock delay (up to 7 days), creating a critical response window if a rogue actor attempts to unlock snapshots.  
