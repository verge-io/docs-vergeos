...
{% hint style="warning" %}
**Drives Must Be Moved from the Original Node**

This procedure only applies when the original drives are transferred to the replacement node. If you need to replace a node **and** its drives, contact [VergeOS Support](https://app.gitbook.com/s/uJc5d3O7cwI7qD8muSyG/support-and-services) for assistance.
{% endhint %}
...
1. A dialog will ask whether you are replacing the node's drives. Select **No** to indicate that the original drives have been moved into this new chassis.
    ...
    {% hint style="info" %}
    **When replacing a node along with its drives, contact [VergeOS Support](https://app.gitbook.com/s/uJc5d3O7cwI7qD8muSyG/support-and-services).**
...
- [Nodes Overview](../system/nodes-overview.md)
- [Creating Bootable Installation Media](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/install-media)

{% hint style="info" %}
**Need Help?**

If you encounter issues or have questions, contact [VergeOS Support](https://app.gitbook.com/s/uJc5d3O7cwI7qD8muSyG/support-and-services).
{% endhint %}
