...
- **[VM Best Practices](vm-best-practices.md)** - Configuration guidelines and recommendations *(20 minutes)*
- **[Creating VMs](creating-vms.md)** - Step-by-step VM creation guide *(15 minutes)*
- **[Uploading Media Images](../storage/uploading-files-to-vsan.md)** - Upload ISOs and installation media *(10 minutes)*
