...
categories:
  - Virtual Machines
description: >-
  Comprehensive overview of VM migration methods for importing workloads into
  VergeOS from VMware, Hyper-V, KVM, and physical servers, including planning
  guidance and supported file formats.
tags:
  - virtual-machines
  - migration
  - import
...
#### [**VergeOS VMware Connector**](import-from-vmware.md)
...
* [VMware Backup DR Guide](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/backup-dr/vmwarebackupdrguide)
* [Importing VMs from VMware Service Backup Jobs](import-from-vmware.md)

#### [**Import from Uploaded File**](import-from-upload.md)
...
#### [**NAS Volume Import**](import-from-nas.md)
...
* New VMs are created, selecting the _--Import from Volume--_ option
...
#### [**VergeOS Clone Utility**](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/virtual-machines/importing-a-physicalvirtual-machine-into-vergeio)
...
* Review [Guest OS Compatibility](guest-os-compatibility.md)
...
* [Viewing Import Jobs](view-import-jobs.md) - Monitor and track import progress
* [VM Best Practices](vm-best-practices.md) - Comprehensive optimization guide
* [Guest OS Compatibility](guest-os-compatibility.md) - Supported operating systems

### Tools and Integrations

* [Cirrus Data Migration Platform](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/cirrus-data) - Enterprise migration solutions
* [Terraform Provider](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/terraform-provider) - Infrastructure as code for automated deployments
