...
![pinnedrules.png](../../assets/screenshots/pinnedrules.png)
...
{% hint style="info" %}
**Rule changes are put into place after you *Apply Rules* (left menu option) or otherwise, the next time the network is restarted.**
