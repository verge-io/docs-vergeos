...
![troubleshooting-verifyipaddress.png](../../assets/screenshots/troubleshooting-verifyipaddress.png)
...
{% hint style="success" %}
**Default addressing for a Layer3 internal network: network segment: 192.168.0.0/24; router address: 192.168.0.1 To check a network's addressing, see [Determining Network Addresses](#determining-network-addresses)**
...
![troubleshooting-verifyinterface.png](../../assets/screenshots/troubleshooting-verifyinterface.png)
...
Example:
![showdefgwrule.png](../../assets/screenshots/showdefgwrule.png)
...
Example:
![defaultgw-create.png](../../assets/screenshots/defaultgw-create.png)
...
![findnetworkaddress.png](../../assets/screenshots/findnetworkaddress.png)
