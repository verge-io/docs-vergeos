...
categories:
  - Storage
description: >-
  Explains the Preferred Tier setting in VergeOS vSAN, which determines the
  first-choice storage tier for data placement with automatic fallback to
  alternative tiers when unavailable.
tags:
  - preferred-tier
  - storage-tiers
  - vsan
