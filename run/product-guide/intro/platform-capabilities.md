...
categories:
  - Getting Started
description: >-
  Catalog of VergeOS platform features including distributed storage, backup/DR,
  compute virtualization, multi-tenancy, software-defined networking,
...
[**Learn about VergeOS Backup and Recovery features →**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/backup-and-dr/overview)

* [**Snapshots**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/backup-and-dr/snapshots-overview) - Protect your data and operations with restore points for the entire system and individual tenants/VMs/NAS volumes
* [**Site Syncs**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/backup-and-dr/sync-configuration) - Replicate copies of your complete system off-site, ready for quick recovery
...
* [**VM Recipes**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/automation/vm-recipes) - Automate and streamline your workload deployments with customizable templates
...
[**Inuvika Integration with VergeOS**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/inuvika) provides complimentary, advanced VDI functionality in conjunction with VergeOS efficient virtualization.
{% endhint %}
...
[**Cirrus Data Integration with VergeOS**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/cirrus-data) - Cirrus-VergeOS integration provides auxiliary tools that automate and accelerate large-scale imports to VergeOS from any cloud or on-premises platform.
{% endhint %}
...
* [**Tenant Recipes**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/automation/tenant-recipes) - Accelerate and standardize tenant deployment for efficiency, compliance, and self-serve systems
...
* [**VergeOS Recipes**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/automation/recipes-overview) - Create customizable templates for accelerated workload and VDC deployments while enforcing important policies
* [**VergeOS Task Engine**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/automation/create-tasks) - Establish automatic operations to trigger based on schedule and/or events for streamlined operations
...
* [**Cirrus Data Integration with VergeOS**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/cirrus-data) - Harness enterprise integration for highly automated and accelerated large-scale transitions from other platforms
...
* [**Inuvika**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/inuvika) - Leverage the advantages of VergeOS combined with Inuvika's advanced virtual desktop infrastructure (VDI) features
* [**Storware**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/storware-backup-recovery) - Utilize Storware integration to layer additional enterprise backup functionality and/or comply with mandatory third-party backup requirements
* [**Terraform Provider**](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/integrations-and-apis/terraform-provider) - Manage VergeOS as part of your infrastructure-as-code (IaC) workflows
