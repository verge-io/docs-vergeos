...
- **[VMware Transition Guide](transition-from-vmware.md)** - Migrate from existing VMware infrastructure
- **[Virtual Machine Management](../virtual-machines/overview.md)** - Learn about VergeHV virtualization capabilities
- **[Tenant Management](../tenants/overview.md)** - Explore multi-tenancy features
<!-- - **[Reference Architectures](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/)** - Review deployment examples for different use cases -->

## Ready to Explore?

Now that you understand the foundational concepts and architecture of VergeOS, explore the complete range of platform capabilities available to you. Our [Platform Capabilities Guide](platform-capabilities.md) provides a comprehensive catalog of features with links to detailed implementation guides.
