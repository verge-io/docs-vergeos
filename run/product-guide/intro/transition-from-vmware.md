...
categories:
  - Getting Started
description: >-
  Guide for VMware administrators migrating to VergeOS, covering architecture
  differences, terminology mapping, networking and storage comparisons, and
  step-by-step VM migration instructions.
tags:
  - vmware
  - migration
  - transition
...
* Access to a VergeOS system or trial environment (see [Bootable Media](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/install-media)).
* A backup of your VMware VMs and configurations before migration. (see [VMware Backup/DR Guide](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/backup-dr/vmwarebackupdrguide)).
...
| **VPN**               | Requires NSX or third-party appliance.                                    | Native IPSec and WireGuard VPN support (see [VPN Overview](../vpn/vpn-overview.md)). |
...
For a detailed guide on planning your network configuration, see [Network Design](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/network-design).
...
**Migration Tip**: Export VMware VMs as OVF/OVA files or use VergeOS’s VMware import tool (see [Import from VMware](../virtual-machines/import-from-vmware.md)).
...
* **VergeOS**: A web UI runs on Controller Nodes, with API access for automation (see [API Guide](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/automation-api/verge-api-guide)).
...
3. **Check Compatibility**: Review VergeOS’s [Guest OS Compatibility](../virtual-machines/guest-os-compatibility.md) for your workloads.

***

### 2. Set Up VergeOS

1. **Install VergeOS**: Follow the [Installation Guide](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/installation-guide) to deploy on at least two nodes (primary and secondary controllers).
2. **Configure Networks**: Set up Core Fabric Networks (dedicated L2) and an External Network matching your VMware VLANs (see [Network Design](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/network-design)).
...
1. **Import VMs**:
   * Use VergeOS’s VMware import feature: Upload OVF/OVA files or connect directly to vSphere (see [Import from VMware](../virtual-machines/import-from-vmware.md)).
   * Alternatively, upload disk images to vSAN and create new VMs (see [Uploading Files to vSAN](../storage/uploading-files-to-vsan.md)).
...
1. **Leverage Tenants**: Assign VMs to tenants for multi-tenancy or isolation (see [Creating Tenants](../tenants/create-tenants.md)).
2. **Set Up Snapshots**: Configure system snapshots for backup and DR (see [Snapshots Overview](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/backup-and-dr/snapshots-overview)).
3. **Monitor Performance**: Use the VergeOS UI to track node and VM metrics (see [Nodes Overview](../system/nodes-overview.md)).
...
* [VM Best Practices](../virtual-machines/vm-best-practices.md) - Optimize your virtual machine configurations.
* [Network Design](https://app.gitbook.com/s/Q2bN3ctQdjv01GivTI08/implementation-guide/network-design) - Plan and refine your network architecture.
* [Snapshots Overview](https://app.gitbook.com/s/sppYQkyIET58BuAo0kqm/backup-and-dr/snapshots-overview) - Set up backup and disaster recovery.
* [Creating Tenants](../tenants/create-tenants.md) - Organize workloads with multi-tenancy.
* [API Guide](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/automation-api/verge-api-guide) - Automate management tasks with the VergeOS API.
