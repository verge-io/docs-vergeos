...
{% hint style="danger" %}
**Exercise Caution with Advanced Settings**
...
| ***SMART max hours a drive can reach before a warning is set*** | Sets the maximum operational (power-on) hours for a drive before triggering an **"HD Warning - hours exceeded maximum threshold(s)"** alert. Default is 43800 hours (5 years); maximum value is 87600 hours (10 years). Additional information on *SMART max hours* below.  | 43800 |
