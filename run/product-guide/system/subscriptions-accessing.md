...
description: >-
  How to view and access your own subscriptions and all system subscriptions in
  VergeOS, including navigation paths and permission considerations.
tags:
  - subscriptions
  - notifications
  - alerts
...
*   Click the **Subscriptions icon (top right)** and select **All My Subscriptions** (to view all) or select **Page Subscriptions** (to view only subscriptions associated to the current page.)
    ...
    ![subscriptions-icon-white.png](../../.gitbook/assets/subscriptions-icon-white.png)
    ...
    ![subscriptions-icon-orange.png](../../.gitbook/assets/subscriptions-icon-orange.png)
...
{% hint style="success" %}
**Throughout the VergeOS UI, the&#x20;**_**Sort**_**&#x20;and&#x20;**_**Filter**_**&#x20;Options at the top of columns can be helpful for working with longer lists.**
{% endhint %}
