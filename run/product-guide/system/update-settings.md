...
description: >-
  Reference for VergeOS update settings, including update source,
  authentication, automatic updates, warm reboot, multi-cluster updates,
  snapshot policies, and privacy settings.
tags:
  - updates
  - settings
  - configuration
