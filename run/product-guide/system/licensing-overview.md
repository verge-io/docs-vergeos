...
2. Contact [VergeOS Support](https://app.gitbook.com/s/uJc5d3O7cwI7qD8muSyG/support-and-services) and provide both the old and new System IDs.
...
- [Licensing and Software Updates](licensing-and-updates.md) — Managing updates and update server configuration
- [Verify Licensing and Update Server Configuration](license-updates-verify.md) — Troubleshooting licensing connectivity
- [System Settings Overview](settings-overview.md) — General system settings reference
