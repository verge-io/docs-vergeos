...
{% hint style="info" %}
**Sending directly to VergeIO Support**
...
{% hint style="warning" %}
**While System Diagnostics files never contain user data, potentially sensitive items such as IP addressing, network details, tenant and VM Names are included.  Use care in downloading and transporting a system diagnostic file to ensure that only authorized personnel have access.**
