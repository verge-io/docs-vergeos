...
categories:
  ...
  - UI
description: >-
  An introduction to the VergeOS 26 user interface, covering dashboard
  navigation, menus, themes, auto-refresh, and help access for new and
...
{% hint style="success" %}
**Transitioning from VergeOS 4.13 to 26.0**
...
VergeOS includes **Default Light Mode** and **Default Dark Mode** themes. Organizations can also create custom branded themes.
...
For details on creating and managing custom themes, see the [Themes documentation](system/themes.md).
...
* **Orange icon** = Auto-refresh enabled (default)
* **Black/White icon** = Auto-refresh disabled
...
**Method 2**: Click the question mark icon in the utility bar (top-right) and select **Product Guide**
...
Tags allow you to organize and categorize objects throughout VergeOS. For details on creating and using tags, see the [Tags documentation](system/tags.md).
