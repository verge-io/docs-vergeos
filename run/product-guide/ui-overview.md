...
- Links to individual network dashboards for detailed management
  ...
  ![Light mode Networks Dashboard](../assets/screenshots/networks-dashboard-light.png)
  ![Dark mode Networks Dashboard](../assets/screenshots/networks-dashboard-dark.png)
...
![Light mode VM Dashboard](../assets/screenshots/vm-dashboard-light.png)
![Dark mode VM Dashboard](../assets/screenshots/vm-dashboard-dark.png)
