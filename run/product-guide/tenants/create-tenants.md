...
{% hint style="success" %}
**[KB Article: *Tenant Node Planning Guide*](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/tenants/tenant-node-planning-guide) walks through the considerations involved in deciding the number of tenant nodes to employ and RAM/Cores to assign to those tenant nodes.**
