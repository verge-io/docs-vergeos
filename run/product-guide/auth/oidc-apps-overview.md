...
2. [Setting Up VergeOS as an OIDC Provider](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/system-administration/setting-up-vergeos-as-identity-provider-oidc)

{% hint style="success" %}
**Multiple OIDC applications can be created on the same system to accommodate different configurations.**


{% endhint %}

3. [Configuring VergeOS as an OIDC Client](https://app.gitbook.com/s/QZBMFpokMv2vWTIRbFzA/system-administration/configuring-vergeos-as-oidc-client)
