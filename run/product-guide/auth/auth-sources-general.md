...
{% hint style="info" %}
**Users that will use an external Authorization Source can optionally be created manually in VergeOS; when creating the new VergeOS user: Select appropriate **Authorization Source** in the dropdown list.**
